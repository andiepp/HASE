...
internal sealed class ExecuteCommandResponsePayloadFormatter
{
        ...
        ReadOnlyMemory<byte> payload)
    {
        ...
        fields.Add(
            new PayloadField(
                ...
                variantTypeBytes,
                $"Variant Type = " +
                $"{GetVariantTypeName(response.ReturnValue)} " +
        ...
        if (offset != payload.Length)
        {
            throw new InvalidDataException(
                $"The ExecuteCommandResponse payload contains " +
            ...
            case bool:
                {
                    ...
                    fields.Add(
                        new PayloadField(
                            offset,
                            valueBytes,
                            $"Boolean Return Value = {booleanValue}"));
            ...
            case string:
                {
                    ...
                    fields.Add(
                        new PayloadField(
                            offset,
                            lengthBytes,
                            $"String Return Value byte length = " +
                            $"{byteCount}"));
        ...
        string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"The ExecuteCommandResponse payload ended while " +

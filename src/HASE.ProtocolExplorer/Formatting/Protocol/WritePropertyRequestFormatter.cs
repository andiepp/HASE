...
internal sealed class WritePropertyRequestFormatter
    : IProtocolMessageFormatter
{
        ...
        ProtocolMessage message)
    {
        ...
        return message is WritePropertyRequest;
    }
        ...
        ProtocolMessage message)
    {
        ...
        if (message is not WritePropertyRequest request)
        {
        ...
        [
            ...
            $"Value         : {FormatValue(request.Value)}"
        ];
    }

...
/// <summary>
/// Owns one unstarted mutual-TLS loopback Command host and its isolated
/// physical-validation authentication resources.
/// </summary>
internal sealed class CapabilityC033SecureHostComposition
    : IAsyncDisposable
{
    private bool disposed;

    private CapabilityC033SecureHostComposition(
    ...
    /// <summary>
    /// Creates an unstarted secure host exposing supplied snapshot, Property,
    /// and Command services.
    /// </summary>
    public static async Task<CapabilityC033SecureHostComposition> CreateAsync(
        ...
        DateTimeOffset validationTimeUtc)
    {
        ...
        try
        {
            ...
            var result =
                new CapabilityC033SecureHostComposition(
                    application,
                    authenticationComposition);

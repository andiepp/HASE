...
public sealed partial class PythonLaptopMiniPcCommandExecutionAuthorizer
{
    ...
    public async Task<PythonLaptopMiniPcCommandExecutionAuthorizationResult>
        AuthorizeAsync(
            PythonLaptopMiniPcCommandExecutionAuthorizationRequest request,
            CancellationToken cancellationToken = default)
    {
        ...
        catch (PythonLaptopMiniPcCommandExecutionAuthorizationException)
        {
            if (published)
            {
                Rollback(
    ...
    private static byte[] Candidate(byte[] original)
    {
        try
        {
            ...
            if (permissions.Contains(
                    "command.execute", StringComparer.Ordinal))
            {
    ...
    private static PythonLaptopMiniPcCommandExecutionAuthorizationException

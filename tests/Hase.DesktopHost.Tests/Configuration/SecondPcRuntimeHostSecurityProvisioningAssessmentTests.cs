...
public sealed class SecondPcRuntimeHostSecurityProvisioningAssessmentTests
{
    [Fact]
    public void AllResultsReady_ShouldBeReady()
    {
        SecondPcRuntimeHostSecurityProvisioningAssessment assessment = Create();
    ...
    private static SecondPcRuntimeHostSecurityProvisioningAssessment Create() =>

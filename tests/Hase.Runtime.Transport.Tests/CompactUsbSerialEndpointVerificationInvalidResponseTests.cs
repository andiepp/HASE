...
public sealed class CompactUsbSerialEndpointVerificationInvalidResponseTests
{
    [Fact]
    public async Task VerifyAsync_InvalidCompactData_ShouldRejectCandidate()
    {
        var candidate =
        ...
        var exception =
            new InvalidDataException(
                "The compact bootstrap response is invalid.");

...
{
    Write-Error "MiniPC Python authoritative Property validation failed: python-environment-unavailable."
    exit 1
}

& $virtualEnvironmentPython `
    -m hase._physical_minipc_authoritative_property_validation `
    $ProfilePath
